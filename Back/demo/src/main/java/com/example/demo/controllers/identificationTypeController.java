...
public class identificationTypeController {
    ...
    @PostMapping()
    public identificationTypeModel insertidentificationType(@RequestBody identificationTypeModel identificationType) {
        return identificationTypeService.insertIdentificationType(identificationType);
    }
}
